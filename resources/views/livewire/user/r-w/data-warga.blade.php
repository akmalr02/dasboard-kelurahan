            ...
            <div x-data="{ open: false, selectedData: null }">
                ...
                <div x-show="open"
                    ...
                    <div @click.away="open = false" class="bg-white rounded-xl shadow-lg max-w-md w-full p-6">
                        ...
                        <!-- Dropdown RT -->
                        <div class="mb-4" x-show="selectedData === 'warga_rt'">
                        ...
                        <div class="mt-6 flex justify-end space-x-2">
                            ...
                            <button @click="if(selectedData){ open = false; $wire.downloadData(selectedData) }"
                                ...
                                :disabled="!selectedData || (selectedData === 'warga_rt' && !selectedRT)">
                                Unduh
                            </button>
                        </div>
                    </div>
        ...
        @if ($search)
            <div class="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p class="text-sm text-blue-700">
                    ...
                    <span class="text-blue-600">({{ $wargas->total() }} data ditemukan)</span>
                </p>
            </div>
        @endif
