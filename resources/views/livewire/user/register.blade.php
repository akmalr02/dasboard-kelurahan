    ...
    <div class="flex flex-col md:flex-row bg-gray-100 rounded-2xl shadow-2xl overflow-hidden w-full max-w-6xl">
        ...
        <div class="w-full md:w-1/2 p-8 sm:p-10" x-data="{ showPassword: false }" x-cloak>
            ...
            <div class="flex items-center space-x-4 mb-10">
                <div>
                    <h1 class="text-4xl font-bold text-gray-900">Registrasi akun mu!</h1>
                    <h1 class="py-3 text-gray-900">Silahkan isi Form registrasi Dahulu</h1>
                </div>
            </div>
            ...
            <form class="space-y-6" wire:submit.prevent="register">
                ...
                {{-- NKK --}}
                <div>
                    <label for="NKK" class="block text-sm font-medium text-gray-900">NKK Anda</label>
                    <div class="mt-2">
                        <input type="text" name="NKK" id="NKK" required autocomplete="NKK"
                            class="block w-full rounded-full bg-gray-100 border border-gray-300
                            px-4 py-2 pr-12 text-sm text-gray-900 shadow-sm placeholder:text-gray-400
                            focus:border-blue-500 focus:ring-blue-500"
                            @error('NKK') border-red-500 @enderror" placeholder="Masukkan NKK Anda..."
                            wire:model.defer="NKK">
                        @error('NKK')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div>
                    <button type="submit"
                        ...
                        <span wire:loading wire:target="register" class="flex justify-center items-center gap-2">
