                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            @if ($jenis === 'pengantar')
                                <td class="px-6 py-4 text-left">
                                    ...
                                    <div class="text-sm text-gray-500">{{ $surat->email ?? 'Email tidak tersedia' }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-left">
                            ...
                            @elseif ($jenis === 'kelahiran')
                                <td class="px-6 py-4 text-left">
                                    <div class="font-medium text-gray-900">{{ $surat->nama }}</div>
                                    <div class="text-sm text-gray-500">{{ $surat->jenis_kelamin }}</div>
                                </td>
                                <td class="px-6 py-4 text-left">{{ $surat->ayah->nama ?? '-' }}</td>
                                <td class="px-6 py-4 text-left">{{ $surat->ibu->nama ?? '-' }}</td>
                                <td class="px-6 py-4 text-left">
                            ...
                            @elseif ($jenis === 'kematian')
                                <td class="px-6 py-4 text-left">
                                    ...
                                    @endphp
                                    <div class="text-sm text-gray-500">{{ $umur ? "$umur tahun" : '-' }}</div>
                                </td>
                                <td class="px-6 py-4 text-left">{{ $surat->jenis_kelamin ?? '-' }}</td>
                                <td class="px-6 py-4 text-left">
                                    {{ \Carbon\Carbon::parse($surat->tanggal_meninggal)->format('d M Y') }}
                                </td>
                                <td class="px-6 py-4 text-left">{{ $surat->sebab_meninggal ?? '-' }}</td>
                                <td class="px-6 py-4 text-center">
                                    {{ \Carbon\Carbon::parse($surat->updated_at)->format('d M Y') }}
                                </td>
                            @endif
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center items-center gap-2">
                                    ...
                                    {{-- @if ($surat->kode_verifikasi)
                                        <a href="{{ route('pdf.download', $surat->kode_verifikasi) }}" target="_blank"
