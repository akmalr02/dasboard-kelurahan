<x-modal wire:model="isOpen" maxWidth="max-w-4xl">
    ...
    <div class="flex justify-between items-center p-6 border-b">
        <div class="flex gap-3 items-center">
            ...
            <div>
                <h2 class="text-xl font-semibold text-gray-800">Edit Surat Kematian</h2>
                <p class="text-sm text-gray-500">Perbarui data surat kematian</p>
            </div>
        </div>
    ...
    <div class="p-6">
        ...
        <form wire:submit.prevent="update">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Nama Almarhum -->
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-700">Nama Almarhum</label>
                    <input type="text" wire:model.defer="nama_warga" placeholder="Masukkan nama"
                        class="w-full px-4 py-2 border rounded-lg @error('nama_warga') border-red-500 @enderror">
                    @error('nama_warga')
                ...
                <div>
                    ...
                    <input type="text" wire:model.defer="agama" placeholder="Masukkan agama"
                        class="w-full px-4 py-2 border rounded-lg @error('agama') border-red-500 @enderror">
                    @error('agama')
                        <span class="text-sm text-red-500">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" wire:model.defer="alamat" placeholder="Masukkan alamat"
                ...
                <!-- Hari Meninggal -->
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-700">Hari Meninggal</label>
                    <input type="text" wire:model.defer="hari_meninggal" placeholder="Contoh: Senin"
                        class="w-full px-4 py-2 border rounded-lg @error('hari_meninggal') border-red-500 @enderror">
                ...
                <!-- Tanggal Meninggal -->
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-700">Tanggal Meninggal</label>
                    <input type="date" wire:model.defer="tanggal_meninggal"
                        class="w-full px-4 py-2 border rounded-lg @error('tanggal_meninggal') border-red-500 @enderror">
                ...
                <!-- Jam Meninggal -->
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-700">Jam Meninggal</label>
                    <input type="time" wire:model.defer="jam_meninggal"
                        class="w-full px-4 py-2 border rounded-lg @error('jam_meninggal') border-red-500 @enderror">
                    @error('jam_meninggal')
                        <span class="text-sm text-red-500">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <!-- Penyebab Kematian -->
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-700">Penyebab Kematian</label>
                    <input type="text" wire:model.defer="penyebab" placeholder="Misal: Sakit"
                        class="w-full px-4 py-2 border rounded-lg @error('penyebab') border-red-500 @enderror">
                    @error('penyebab')
                        <span class="text-sm text-red-500">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2">
                    <label class="block mb-2 text-sm font-medium text-gray-700">Tempat Pemakaman</label>
                    <textarea wire:model.defer="tempat_pemakaman" rows="3" placeholder="Masukkan tempat pemakaman"
                        class="w-full px-4 py-2 border rounded-lg resize-none @error('tempat_pemakaman') border-red-500 @enderror"></textarea>
